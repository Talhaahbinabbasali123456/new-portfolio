$(document).ready(function () {
  // your code
  jQuery(".contact-btn").addClass("screenloaded");
});
...
jQuery(".navbar__items").click(function () {
  jQuery(".contact-btn").removeClass("active");
...
jQuery(document).ready(function ($) {
  $('.landing-screen-porfolio .img-wrapper').slick({
    dots: false,
    infinite: true,
    speed: 2000,
    slidesToShow: 1,
